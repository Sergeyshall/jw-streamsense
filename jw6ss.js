...
(function() {
  ...
  JW6SS = (function() {
    ...
    // Setup udm url
    JW6SS.setupUdm  = function(udmUrl) {
        udm_(udmUrl);
    }
    ...
    JW6SS.observe = function(jw) {
      ...
      // xsesh: fix error with object instantiation added Puppet
      ss = (ns_.StreamSense.Puppet) ? new ns_.StreamSense.Puppet : ns_.StreamSense;
